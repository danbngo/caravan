...
export const UNIT_CARDS = {
    ...
    CLOCKWORK_GOLEM: new UnitCard("Clockwork Golem", "A big artificial golem.", 5, 10, 3, [], ["CONTRAPTION", "GIANT"]),
    ABOMINATION: new UnitCard("Abomination", "Giant flesh golem.", 5, 10, 3, ["REND", "CLEAVE"], ["UNDEAD", "GIANT"]),
    ...
    BARRICADE: new UnitCard("Barricade", "Keeps out invaders.", 4, 8, 0, [], ["BUILDING"]),
    ...
    VAMPIRE: new UnitCard("Vampire", "Good at harassing.", 3, 6, 2, ["CAPTIVATE", "LEECH"], ["FLYING", "STEALTHY"]),
    ...
    JAVILENEER: new UnitCard("Javileneer", "Hurls javelins.", 2, 4, 1, ["FORMATION", "RANGED", "SKIRMISH"], ["LIVING"]),
    ...
    SKIRMISHER: new UnitCard("Skirmisher", "Light harassment unit.", 1, 2, 1, ["RANGED", "SKIRMISH"], ["LIVING"]),
...
export const GENERAL_CARDS = {
    GENERAL: new UnitCard("General", "Leader of the army.", 6, 10, 1, [], ["LIVING"])
};
