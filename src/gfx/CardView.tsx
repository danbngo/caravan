...
export function CardView({ card, onClick, isSelected, isTargeted }: { card: UnitCard | GeneralCard | undefined, onClick: CardClickHandler | undefined, isSelected?: boolean | undefined, isTargeted?: boolean | undefined }) {
